        ...
        >
            ...
            >
                ...
                <button
                    ...
                    className="cursor-pointer absolute top-2.5 right-3 text-gray-400 hover:text-gray-700 hover:bg-gray-100 text-sm leading-none p-1.5 rounded-md transition-colors duration-150 cursor-pointer border-none bg-transparent"
                    onClick={onClose}
                >
                    ✕
                </button>
                ...
                <button
                    id="alert-modal-ok"
                    ref={okBtnRef}
                    className="cursor-pointer mt-auto w-full py-2.5 border-none rounded-xl bg-violet-600 text-white font-semibold text-sm cursor-pointer transition-all duration-150 hover:bg-violet-700 hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-violet-400 focus:ring-offset-2"
                    onClick={onClose}
                >
                    OK
                </button>

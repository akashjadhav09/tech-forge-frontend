            ...
            <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="bg-primary h-32 md:h-48 relative">
                    <div className="absolute -bottom-12 left-8 md:left-12">
                        <div className="h-24 w-24 md:h-32 md:w-32 rounded-full ring-4 ring-white bg-white flex items-center justify-center text-primary text-4xl font-bold shadow-md overflow-hidden">
